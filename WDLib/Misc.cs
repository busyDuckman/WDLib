...
namespace WD_toolbox
{
    ...
    /// <summary>
    /// Common healpers that donot fit into any other catergory.
    /// </summary>
    public static class Misc
    {
        ...
        /// <summary>
        /// DO NOT CALL THIS CODE FROM SOFTWARE.
        /// It's for when you have a hude string in the debugger.
        /// Just alter it to .dump() and re-evaluate it. You can now see the
        /// string in c:\temp\dump.txt
        /// </summary>
