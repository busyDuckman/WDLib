...
namespace WD_toolbox.Data.DataStructures
{
    ...
    /// 
    /// Returning a Why is elegant (I have been doing it for years and I see others are catching on).
    /// 
    /// Basically why force a particular error message pattern onto the calling code.
    /// 
    /// usage:
    ///  Why connect() {...}
    /// 
    ...
    /// 
    /// try{
    ///   connect().ThrowOnFalse();
    /// }
    /// 
    /// Why why = connect();
    /// if(!why) {
    ///   writeline(why.Reason);
    /// }
    /// </summary>
    public class Why : ICloneable, IComparable<Why>, IEquatable<Why>
    {
        ...
        public static Why FalseBecause(string reason)
        {
                         ...
                         [CallerMemberName] string member = "")
        {
            ...
            return new Why(false, describeException(ex, location));
        }
                                  ...
                                  [CallerMemberName] string member = "")
        {
            ...
            {
                return Why.FalseBecause(ex, line, file, member);
            }
