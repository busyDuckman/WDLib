...
{
    /// <summary>
    /// I HATE THIS IDEA NOW, AND WANT TO PURGE IT.
    /// 
    /// This class provides for clone/compare-all boiler plate to be semi-automated.
    /// A class delcares as set of DataNames, and the extension methods provide basic
    ...
    /// <summary>
    /// This class provides for clone/compareet al boiler plate to be semi-automated.
    /// A class delcares as set of DataNames, and the extension methods provide basic
    /// implementations of deep copy etc.
    /// 
    /// The order of the items returned in DataNames affects the CompareTo method and 
