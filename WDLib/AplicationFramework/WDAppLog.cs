...
{
    /// <summary>
    /// This is one of the oldest classes in WDLib.
    /// TBH: If there was a great logging solution for .NET back in the early 2000's I would have standardised on that.
    /// But there wasn't, so I built and hardend my own solution.
    /// The goal was not "high performance logging" as I saw C# as an application language. 
    /// The goals were:
    ///   - Being able to get a log out under adverse conditions.
    ///   - Behaving well if the computer didn't let logging proceed (write protection, disk full)
    ///   - Providing good debug information.
    ///   
    /// At some point I tested this quite rigorously, but the code was refactored about 10 years ago and was not put through the torture tests a second time.
    /// </summary>
