...
{
    /// <summary>
    /// Handels the information assosiated with a file format.
    /// Formats compare to 0 if the name is the same
    /// </summary>
    public class FileFormat : IComparable<FileFormat>, IComparable<string>, IEquatable<FileFormat>
    {
        ...
        #region plain text
        public static readonly FileFormat Object_XML = FromString("XML File (*.xml)");
        public static readonly FileFormat Object_JSON = FromString("JSON File (*.json)");
        #endregion
        ...
        public static string MakeFileDialogeString(IList<FileFormat> formats, bool withAllFiles, string allFormatsHeading)
        {
            ...
            if(allFormatsHeading != null)
            {
                ...
                sb.Append(String.Format("{0} ({1})|{2}", allFormatsHeading, Text.list(wildCards, ", "), Text.list(wildCards, ";")));
            }
            foreach(FileFormat format in formats)
            {
        ...
        public string MakeFileDialogeString()
        {
            ...
            return String.Format("{0} ({1})|{2}", name, Text.list(wildCards, ", "), Text.list(wildCards, ";"));
        }
