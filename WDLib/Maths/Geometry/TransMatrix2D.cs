...
namespace WD_toolbox.Maths.Geometry
{
    ...
    public sealed class TransMatrix2D : ICloneable, IEquatable<TransMatrix2D>
    {
        ...
        private TransMatrix2D()
        {
            ...
            Point2D translate = Point2D.Origen;
            double clockwiseRotation = 0;
            Point2D rotationPos = Point2D.Origen;
        ...
        public static TransMatrix2D FromRotation(double clockWiseRotation, Point2D point)
        {
            ...
            //t.rotationPos = point;
            t.rebuildMatrix(NoScale ,Point2D.Origen,  clockWiseRotation, point);
            return t;
        }
        ...
        public static TransMatrix2D FromTranslation(double x, double y)
        {
            ...
            t.rebuildMatrix(NoScale, new Point2D(x, y), 0, Point2D.Origen);
            return t;
        }
        ...
        public static TransMatrix2D FromScale(double sx, double sy)
        {
            ...
            t.rebuildMatrix(new Point2D(sx, sy), Point2D.Origen, 0, Point2D.Origen);
            return t;
        }
